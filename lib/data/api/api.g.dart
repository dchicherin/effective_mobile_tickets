...
class _OffersApi implements OffersApi {
  _OffersApi(
    this._dio, {
    this.baseUrl,
  });
  ...
  Future<OfferList> getOffers() async {
    ...
    final _result = await _dio
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'v3/da7b7d22-248b-4815-8ceb-a945121da364',
...
class _TicketOffersApi implements TicketOffersApi {
  _TicketOffersApi(
    this._dio, {
    this.baseUrl,
  });
  ...
  @override
  Future<TicketOfferList> getOffers() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result = await _dio
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'v3/21204e59-0202-4fbb-aa02-19d3bb4ccd9c',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
...
class _TicketApi implements TicketApi {
  ...
  @override
  Future<TicketList> getOffers() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result = await _dio
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'v3/1e0eeca5-133f-45c9-bd00-26ac63b19b50',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
